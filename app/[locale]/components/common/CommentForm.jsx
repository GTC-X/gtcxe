...
const CommentForm = ({ blogSlug, blogId }) => {
  ...
  return (
    <div className="bg-gray-100 rounded-lg shadow-lg p-6 md:p-8 mt-8">
      ...
      <form onSubmit={formik.handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2 border bg-white rounded-md focus:outline-none focus:ring-2 focus:ring-secondary ${
        ...
        <div>
          ...
          <textarea
            ...
            onChange={formik.handleChange}
            onBlur={formik.handleBlur}
            className={`w-full px-4 py-2 border bg-white rounded-md focus:outline-none focus:ring-2 focus:ring-secondary resize-y ${
              formik.touched.comment && formik.errors.comment
                ? "border-red-500"
                : "border-gray-300"
            }`}
