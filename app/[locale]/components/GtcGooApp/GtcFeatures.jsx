...
const GtcFeatures = () => {
  const t = useTranslations("gtcGoApp.features");
  
  const features = [
    {
      title: t("items.smarterCopy.title"),
      desc: t("items.smarterCopy.description"),
      Icon: IconFunctionalApp,
    },
    {
      title: t("items.highQuality.title"),
      desc: t("items.highQuality.description"),
      Icon: IconHighQualityDesign,
    },
    {
      title: t("items.integrations.title"),
      desc: t("items.integrations.description"),
      Icon: IconEssentialIntegrations,
    },
    {
      title: t("items.components.title"),
      desc: t("items.components.description"),
      Icon: IconEssentialComponents,
    },
    {
      title: t("items.customizable.title"),
      desc: t("items.customizable.description"),
      Icon: IconFullyCustomizable,
    },
    {
      title: t("items.updates.title"),
      desc: t("items.updates.description"),
      Icon: IconRegularUpdates,
    },
  ];
    
  return (
    <section className="relative py-12 md:py-14 bg-[#f8f8f8] overflow-hidden border-t border-slate-200 border-b">
      {/* LEFT gradient glow */}
      <div className="absolute left-0 top-0 h-[500px] w-[500px] bg-gradient-to-br from-red-50 to-orange-50 rounded-full blur-[120px] opacity-40" />

      {/* RIGHT gradient glow */}
      <div className="absolute right-0 top-0 h-[500px] w-[500px] bg-gradient-to-br from-blue-100 to-indigo-100 rounded-full blur-[120px] opacity-40" />

      <div className="container relative z-10">
        {/* TITLE */}
        <div className="text-center mb-6 md:mb-10 md:max-w-3xl mx-auto">
          <h2 className="text-2xl md:text-4xl font-semibold bg-gradient-to-r from-[#293794] via-[#000021] to-[#000021] text-transparent bg-clip-text">
            {t("title")}
          </h2>
          <p className="text mt-3 text-sm md:text-base">
            {t("subtitle")}
          </p>
        </div>
        ...
        <div className="grid gap-5 md:gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((item, index) => (
            <div
              key={index}
              className="flex flex-col items-center text-center px-4 bg-white rounded-2xl py-8 shadow-md hover:shadow-xl transition"
            >
              {/* Icon Box */}
              <div className="w-16 h-16 rounded-3xl bg-indigo-50 text-secondary flex items-center justify-center shadow-sm mb-4">
...
/* ====== ICONS (converted from your HTML, kept simple) ====== */
